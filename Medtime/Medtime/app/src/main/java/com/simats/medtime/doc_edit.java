...
public class doc_edit extends AppCompatActivity {

    private String username;
    private EditText DoctorId,Gender,DoctorName,Speciality;
    private String name,spec,gend;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.doc_edit);
    ...
    private void sendLoginRequest(final String username) {
        String URL = ip.ipn+"d_profileupdate.php";
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("true")) {
                ...
                Intent intent = new Intent(doc_edit.this, MainActivity2.class);
