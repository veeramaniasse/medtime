...
//        }
        ...
        try {
            ...
            long currentTimeMillis = calendar1.getTimeInMillis();
            ...
            if (delayInMillis < 0) {
                ...
                delayInMillis = targetTimeMillis - calendar1.getTimeInMillis();
            }
...
//        fetchData(username);
    ...
    public void cancelAllAlarms(@NonNull Context context) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);

        for (int i = 0; i < 5; i++) { // Assuming you set multiple alarms with different request codes
            Intent intent = new Intent(context, AlarmHelper.AlarmReceiver.class);
    ...
    private void parseResponse(String response) {
        Log.d("medicine_response", response);
        try {
...
//                Log.d("Medication Time", roundTimeToNearestHalfHour(time));
...
//                Medication medicationDetail =
    ...
    public static void setListViewHeightBasedOnItems(@NonNull ListView listView) {
    ...
    private void addMedicationTimesToList(@NonNull JSONArray intake, List<String> allMedicationTimes) throws JSONException {
    ...
    @NonNull
    private String roundTimeToNearestHalfHour(@NonNull String time) {
...
//        Toast.makeText(requireContext(), hours+"-"+minutes, Toast.LENGTH_SHORT).show();
        Log.d("Time_Testing", hours+"-"+minutes);
        setAlarm(requireContext(), hours, minutes);
...
//        Log.d("Time_Testing_1", hours+"-"+minutes);
